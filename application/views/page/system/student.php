...
<head>
  ...
  <title>Education Sandbox | เข้าสู่ระบบ สำหรับนักเรียน</title>
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="<?php echo base_url();?>assets/images/student.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">ลงชื่อเข้าใช้งานระบบ | สำหรับนักเรียน</p>
                <form id="login" action="<?php echo base_url('login/check_login_student'); ?>" method="post">
...
<script type="text/javascript">
  $("#login").submit(function(e){
    ...
    $.post("<?php echo base_url('login/check_login_student'); ?>", $('#login').serialize())
        .done(function(data) {
            var $arr = jQuery.parseJSON(data);
            var $status = $arr['status'];
            if ($status === "success") {
                setTimeout(function() {
                    $(location).attr("href", "<?php echo base_url('student'); ?>");
                }, 500);
