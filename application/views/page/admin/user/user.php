                    ...
                    <div class="col-12">
                        <div class="card">
                          <div class="card-header">
                                <h4 class="card-title"><i class="fas fa-users"></i> รายการชื่อผู้ใช้งาน</h4>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead class="thead-dark">
                                            <tr>
                                                ...
                                                <th style="width: 150px">รูปประจำตัว</th>
                                                <th>ชื่อ-นามสกุล</th>
                                                <th style="width: 150px">ชื่อผู้ใช้งาน</th>
                                                <th style="width: 150px">ประเภทผู้ใช้งาน</th>
                                                <th style="width: 150px">โรงเรียน</th>
                                                <th class="text-center" style="width: 80px">แก้ไข</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $no = 0; foreach ($users as $data) { ?>
                                            <tr>
                                                <td class="text-center"><?php echo ++$no; ?></td>
                                                <td class="text-center">
                                                  <img class="img-thumbnail" src="<?php echo base_url();?>assets/images/users/<?php echo $data->image; ?>" itemprop="thumbnail" alt="Image description" width="80px"/>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                  <div class="btn-group btn-group-sm" role="group" aria-label="Second Group">
                                                    <a class="btn btn-icon btn-outline-success waves-effect waves-light" onclick="view('<?php echo $data->aid; ?>')"><i class="fal fa-info-square"></i></a>
                                                    <a class="btn btn-icon btn-outline-info waves-effect waves-light" onclick="edit('<?php echo $data->aid; ?>')"><i class="fal fa-edit"></i></a>
                                                    <a class="btn btn-icon btn-outline-danger waves-effect waves-light" onclick="del('<?php echo $data->aid; ?>')"><i class="far fa-trash"></i></a>
                                                  </div>
                                                </td>
                                            </tr>
                                            <?php } ?>
