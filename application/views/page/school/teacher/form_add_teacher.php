        ...
        <div class="content-wrapper">
            <div class="content-body">
              ...
              <section class="add__student form__design">
                    <div class="container">
                        <form action="#" method="post" id="form_add_teacher" class="needs-validation" novalidate enctype="multipart/form-data">
                            <div class="card">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="username" name="username" placeholder="ชื่อผู้ใช้ของครู" onKeyUp="Iscard(this.value,this)" minlength="13" maxlength="13"  required>
...
$(document).ready(function() {
    ...
    /* ------------------------- Add student ------------------------- */
    $('#form_add_teacher').submit(function(e) { 
        e.preventDefault();
        ...
        if(username == "" || 
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo base_url('School/add_teacher/');?>',
                    type: "post",
                    ...
                    success: function(data) {
                        ...
                        swal({
                              title: "สำเร็จ!",
                              text: "ทำการเพิ่มครูเรียบร้อยแล้ว?",
                              type: "success",
