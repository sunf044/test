                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="room_no" name="room_no" onKeyUp="IsNumer(this.value,this)" placeholder="เลขห้อง" value="" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="room_name" name="room_name" placeholder="ชื่อห้อง" value="" required>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="class_" name="class_" placeholder="" onKeyUp="IsNumer(this.value,this)" value="" required>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="class_room" name="class_room" placeholder="" onKeyUp="IsNumer(this.value,this)" value="" required>
    ...
    $('#form_room').submit(function(e) {
        ...
        if (room_no == "" ||
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo base_url('School/add_room'); ?>',
                    type: "post",
