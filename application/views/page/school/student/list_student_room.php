                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">รายการนักเรียนเข้าห้อง</h4>
                                    <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">

                                             <li><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAddStudentRoom">
                                             <i class="fas fa-plus-square mr-2"></i> เพิ่มนักเรียนเข้าห้อง
                                            </button></li>
...
<!--                                             <li><a data-action="close"><i class="ft-x"></i></a></li>
 -->                                        </ul>
                                ...
                                <?php if ( ! empty($page_student_room)){ ?>
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                <?php $i=0 ; foreach ($page_student_room as $row) {?>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-warning text-white" onclick="showModalEditStudentRoom(<?= $row['stdrid']; ?>);">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                             / 
                                                            <button type="button" class="btn btn-danger" onclick="del(<?= $row['stdrid']; ?>);">
...
<!-- Modal add -->
     <div class="modal fade text-left" id="modalAddStudentRoom" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600" id="myModalLabel33">เพิ่มห้องนักเรียน</label>
                         ...
                         <div class="col-lg-6 col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control" id="student_id" name="student_id" style="width: 100%;" required>
                                    ...
                                    <?php foreach($getAllStudentNotRoom as $row) { ?>
