        ...
        <div class="content-wrapper">
            <div class="content-body">
              ...
              <section class="add__student form__design">
                    <div class="container">
                        <form action="#" method="post" id="form_update_teacher" class="needs-validation" novalidate enctype="multipart/form-data">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" class="form-control" id="aid" name="aid" value="<?= $row['aid']; ?>">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="first_name">ชื่อผู้ใช้ของครู <small class="text-danger">*</small></label>
                                                    <input type="text" class="form-control" id="username" name="username" placeholder="ชื่อผู้ใช้ของครู" onKeyUp="Iscard(this.value,this)" minlength="13" maxlength="13" value="<?php echo $row["username"];?>" required>
                                                    <div class="invalid-feedback">
                                                        กรุณากรอกชื่อผู้ใช้ของครู
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="collapse show" id="form-image">
                                        ...
                                        <?php if($row['image'] != ""){?>
                                            <div class="col-12">
                                                <div align="center">
                                                <img src="<?= base_url() ?>assets/images/users/<?= $row['image']; ?>" class="img-fluid rounded" width="200px" height="200px">
                                                </div>
                                                </br>        
                                            </div>
                                        <?php }?>
       ...
       if(username.length == "13"){
        ...
        if(aid == "" ||
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo base_url('School/update_teacher/');?>'+ aid,
                    type: "post",
                    ...
                    success: function(data) {
                        ...
                        swal({
                              title: "สำเร็จ!",
                              text: "ทำการแก้ไขข้อมูลครูเรียบร้อยแล้ว?",
                              type: "success",
