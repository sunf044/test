                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">แสดงหน้าจัดการเกรดนักเรียน : รายการวิชาเรียน</h4>
...
<!--                                             <li><a data-action="close"><i class="ft-x"></i></a></li>
 -->                                        </ul>
                                ...
                                <?php if ( ! empty($page_list_student_subject)){ ?>
                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <tbody>
                                                <?php $i=0 ; foreach ($page_list_student_subject as $row) {?>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center"><?= $row['name_subject']; ?> <?php if($row['initials'] != ""){
                                                            echo "(".$row['initials'].")";
                                                        } ?></td>
