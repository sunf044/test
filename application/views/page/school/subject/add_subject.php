                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name_subject" name="name_subject"  placeholder="ชื่อวิชา" value="" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="first_name">รหัสวิชา <small class="text-danger">*</small></label>
                                                <input type="text" class="form-control" id="code_subject" name="code_subject" placeholder="รหัสวิชา" value="" required>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="initials" name="initials" placeholder="ชื่อย่อวิชา" value="" required>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" onKeyUp="IsNumer(this.value,this)" id="unit" name="unit" placeholder="หน่วยกิต" value="" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value="">เลือกประเภทวิชา</option>
                                                    <?php foreach ($subject_type as $data) { ?>
                                                        <option value="<?php echo $data->sjtid; ?>">
    ...
    $('#form_room').submit(function(e) {
        ...
        subject_id == ""
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo base_url('School/add_subject'); ?>',
                    type: "post",
