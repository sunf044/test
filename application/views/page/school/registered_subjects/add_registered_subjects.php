    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <section class="add__student form__design">
                <div class="container">
                    <form action="#" method="post" id="form_add" class="needs-validation" novalidate enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header bg-night-light">
                                <h5 class="font-weight-bold mb-0">
                                    เพิ่มลงทะเบียนรายวิชา
                                </h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php foreach ($data_year as $data) { ?>
                                                        <option value="<?php echo $data->syid; ?>" >
                                                            <?php echo $data->year; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
    ...
    $('#form_add').submit(function(e) {
        ...
        term == ""
            ...
            Swal.fire({
                ...
                $.ajax({
                    url: '<?php echo base_url('School/add_registered_subjects/'); ?>',
                    type: "post",
